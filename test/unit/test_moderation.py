...
class TestModeration(StanzaHandlerTest):
    def test_parse_moderation_message(self):
        ...
        self.assertEqual(props.moderation.by, JID.from_string('room@muc.example.com/macbeth'))
        ...
        self.assertEqual(props.moderation.occupant_id, 'dd72603deec90a38ba552f7c68cbcc61bca202cd')
